    ...
    <form action={formAction} className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field
          ...
          autoComplete="off"
        />
        <Field name="name" label={t('products.name')} required />
        <Field
          name="price"
          ...
          placeholder="2,50"
        />
        <Field name="cost" label={t('products.cost')} inputMode="decimal" />
        <Field name="unit" label={t('products.unit')} placeholder="und" />
        <Field name="initialStock" label={t('products.initialStock')} inputMode="decimal" />
        <Field name="minStock" label={t('products.minStock')} inputMode="decimal" />
      </div>
